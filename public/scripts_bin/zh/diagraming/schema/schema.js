var Schema = {
  selectedCategories: ["standard", "basic", "flow", "lane"],
    ...
    for (var c in this.shapeDefaults) {
      if (c == "attribute") {
        ...
        if (c == "props") {
          ...
          if (c == "shapeStyle") {
            a.shapeStyle = this.extend(
              b.shapeStyle,
              this.shapeDefaults.shapeStyle
            );
          } else {
            if (c == "lineStyle") {
  ...
  initShapeFunctions: function (shape) {
    ...
    eval(pathEval);
    var anchorsEval =
      "shape.getAnchors = function(){var w = this.props.w; var h = this.props.h; return [";
